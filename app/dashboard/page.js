...
export default function Journal() {
  return (
    <div>
      <UserNav />
      <div className="bg-gray-200 h-screen text-xl flex shadow-sm">
        {/* left menu */}
        <div className="w-1/3 p-3 h-full bg-gray-300 border-r-2 border-gray-500 rounded-l-md">
          <div className="flex flex-col items-center">
            <button className="btn mt-5 text-lg inline-block">New Entry</button>
          </div>
          ...
          <ul className="my-2 ml-2">
            ...
            <li className="flex my-2 relative hover:cursor-pointer">
              <Image
                className="absolute bottom-1.5 mr-1"
                width={20}
                height={20}
                src="/icons/quote.svg"
              />
              <h3 className="ml-6">Quotes</h3>
            </li>
            <li className="flex my-2 hover:cursor-pointer">
              <Image
                className="mr-1"
